import Type from "./supportClasses/typeclass.js";
...
export default function sketch2(data) {
  let sk = (s) => {
    ...
    let str =
      "Projet P.ART-OUT. Études de spatialization du texte en Réalité Augmenté";
    let str_arr = [];
    let font;
    let sdgreg;
    ...
    s.preload = () => {
      font = s.loadFont("../../../media/fonts/SpaceGrotesk-Regular.otf");
    };
